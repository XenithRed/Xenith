...
exports.acceptVisionLicense = acceptVisionLicense;
...
async function acceptVisionLicense() {
    try {
...
async function generateText(history) {
...
async function analyzeImage(imageBuffer, question) {
